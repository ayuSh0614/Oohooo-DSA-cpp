...
// // {
// //     vector<vector<int>> v;
// //     vector<int> v1 = {1,2,3678,4,34565};
// //     vector<int> v2 = {3,2,3,4,3455};
// //     vector<int> v3 = {45,2,345,4,5};
// //     vector<int> v4 = {22,245,3,4098,5};
...
//     void that(int low, int high, TreeNode* &temp, vector<int> &num)
//     {
//         if(low > high)
//         {
//             return ;
...
//         int maci = *max_element(num.begin()+low, num.begin()+high+1);
//         int index = find(num.begin()+low, num.begin()+high, maci) - num.begin();
//         temp = new TreeNode;
//         temp->val = maci;
//         temp->left = NULL;
//         temp->right = NULL;
//         that(low, index - 1, temp->left, num);
//         that(index+1, high, temp->right, num);
//     }


//     TreeNode* constructMaximumBinaryTree(vector<int>& nums) {
//         TreeNode* temp = NULL;
//         that(0, nums.size()-1, temp, nums);
//         return temp;
//     }
// };
